    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <a href="{{ route('crear_slide') }}" class="btn btn-primary">Crear slide</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="buscando" placeholder="Buscar slide..." value="{{ $listado->old('buscando') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    @forelse($slides as $slide)
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a href="{{ route('eliminar_slide', compact('slide')) }}" role="button" class="btn btn-danger btn-circle axys-confirmar-eliminar"><i class="glyphicon glyphicon-remove"></i></a>
                            </td>
                            <td class="hidden">{{ $slide->id }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="3">No se encontraron slides.</td>
                        </tr>
                    @endforelse
                    <?php $slide = null; ?>
                </tbody>
