    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <a href="{{ route('crear_icono') }}" class="btn btn-primary">Crear ícono</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="buscando" placeholder="Buscar icono..." value="{{ $listado->old('buscando') }}">
                            </div>
                        </div>
                    </div>
                ...
                <tbody>
                    @forelse($iconos as $icono)
                        <tr>
                            ...
                            <td class="text-right">
                                {!! accion_visibilidad($icono->visible, route('visibilidad_icono',compact('icono'))) !!}
                                <a href="{{ route('editar_icono', compact('icono')) }}" role="button" class="btn btn-warning btn-circle"><i class="glyphicon glyphicon-edit"></i></a>
                                <a href="{{ route('eliminar_icono', compact('icono')) }}" role="button" class="btn btn-danger btn-circle axys-confirmar-eliminar"><i class="glyphicon glyphicon-remove"></i></a>
                            </td>
                            <td class="hidden">{{ $icono->id }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="99">No se encontraron íconos.</td>
                        </tr>
                    @endforelse
                    <?php $icono = null; ?>
                </tbody>
